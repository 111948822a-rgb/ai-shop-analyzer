...
def test_api_with_body(access_token, shop_cipher, api_path, body):
...
def main():
    logger.info("=" * 60)
    logger.info("TikTok Shop Partner API Debug - Product API")
    logger.info("=" * 60)
    ...
    if shop_cipher:
        ...
        test_api_with_body(access_token, shop_cipher, "/product/202309/products/query", body)
        test_api_with_body(access_token, shop_cipher, "/product/202309/products/list", body)
        test_api_with_body(access_token, shop_cipher, "/product/202309/product/search", body)
